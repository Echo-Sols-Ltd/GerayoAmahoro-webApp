...
export default function LoginPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Redirect to business portal on successful login
      ...
      <div className="lg:w-1/2 bg-gradient-to-br from-[#344B77] to-[#2a3d63] flex items-center justify-center p-8 lg:p-12">
        <div className="max-w-md text-center text-white">
          ...
          <p className="text-lg text-blue-100 mb-8">
            Sign in to access your business portal and manage your delivery operations with ease.
          </p>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              ...
              <Link href="/signup" className="text-[#344B77] hover:underline font-medium">
                Sign up here
              </Link>
            </p>
          </div>
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center">
                <input
                  ...
                  onChange={handleInputChange}
                  className="w-4 h-4 text-[#344B77] border-gray-300 rounded focus:ring-[#344B77]"
                />
                <span className="ml-2 text-sm text-gray-600">Remember me</span>
              </label>
              <Link
                href="/forgot-password"
                className="text-sm text-[#344B77] hover:underline"
              >
                Forgot password?
              </Link>
            </div>
